...
using static LIN.Contacts.Client.Online.Scripts;
namespace LIN.Contacts.Client.Components;
...
public partial class Emma
{
    ...
    private async void ToEmma()
    {
        ...
        // Respuesta.
        var response = await LIN.Access.Contacts.Controllers.Profiles.ToEmma(Prompt, Access.Contacts.Session.Instance.AccountToken);
